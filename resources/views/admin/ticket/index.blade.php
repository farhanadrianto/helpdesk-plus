...
background:#2563eb;
color:white;
padding:7px 0; /* Padding atas-bawah 7px, kiri-kanan 0 karena lebar diatur width */
border-radius:6px;
text-decoration:none;
display:inline-block;
width:80px; /* Menentukan lebar pasti tombol */
text-align:center;
font-size:14px;
border: 1px solid transparent; /* Mencegah selisih pixel dengan button yang punya border */
...
background:#dc2626;
color:white;
padding:7px 0; /* Disamakan dengan .btn */
border: 1px solid transparent;
border-radius:6px;
cursor:pointer;
margin-left:5px;
display:inline-block;
width:80px; /* Lebar disamakan dengan .btn */
text-align:center;
font-size:14px; /* Ukuran font disamakan */
box-sizing: border-box;
}
...
<a href="{{ route('admin.ticket.index') }}" class="tab active-tab">

Active Tickets

</a>

<a href="{{ route('admin.ticket.archive.index') }}" class="tab inactive-tab">
